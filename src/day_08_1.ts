...
const allCircuits = Array.from(cTop.values()).sort((a, b) => b.length - a.length)

let sum = allCircuits[0]!.length * allCircuits[1]!.length * allCircuits[2]!.length
